...
public class SortStep{
  ...
  private P6_Bruckhaus_Alexander_Sorts mySorts;
  ...
  public SortStep(){
    ...
    mySorts = new P6_Bruckhaus_Alexander_Sorts();
    myArray = null;
    listType = "Integer";
  }
  ...
  public void sortMenu(){
    ...
    do{
      ...
      System.out.println("(0) Gnome sort");
      System.out.println();
      System.out.print("Choice ---> ");
      choice = console.next() + " ";
      if ('0' <= choice.charAt(0) && choice.charAt(0) <= '6'){
        System.out.println();
